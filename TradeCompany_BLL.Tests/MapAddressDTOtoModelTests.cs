...
namespace TradeCompany_BLL.Tests
{
    class MapAddressDTOtoModelTests
    {
        ...
        [TestCaseSource(typeof(MapAddressDTOToAddressModelSource))]
        ...
        [TestCaseSource(typeof(MapAddressDTOToAddressStringSource))]
        public void MapAddressDTOToAddressStringTest(List<AddressDTO> addressesDTO, List<String> expected)
        {
            List<String> actual = mapsDTOtoModel.MapAddressDTOToAddressString(addressesDTO);
    ...
    public class MapAddressDTOToAddressModelSource : IEnumerable
    {
        public IEnumerator GetEnumerator()
        {
            ...
            yield return new object[]
            {
                ...
                new List<AddressModel>(){ new AddressModel(1, 8, "Lenina 1"), new AddressModel(2, 8, "Москва, ул. Советская 3/1")}
            };
        }
    }

    public class MapAddressDTOToAddressStringSource : IEnumerable
    {
        public IEnumerator GetEnumerator()
        {
            yield return new object[]
